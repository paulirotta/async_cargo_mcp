...
use async_cargo_mcp::operation_monitor::{OperationMonitor, MonitorConfig};
use std::sync::Arc;
...
"#;
    ...
    let async_cargo_sync = AsyncCargo::new_with_config(monitor.clone(), shell_pool_manager.clone(), true);
